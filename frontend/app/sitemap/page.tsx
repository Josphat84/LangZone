    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 font-sans text-gray-800">
      <main className="container mx-auto px-4 sm:px-6 py-8 md:py-12 max-w-4xl">
        ...
        <section className="text-center mb-10">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-4">Site Map</h1>
        ...
        <Card className="bg-white border border-gray-100 shadow-md rounded-xl">
          <CardContent className="p-6 md:p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-6">
              ...
              {/* Main Sections */}
              <div>
                <h2 className="font-bold text-teal-700 text-xl md:text-2xl mb-4">Main Sections</h2>
              ...
              {/* Company & Support */}
              <div>
                <h2 className="font-bold text-teal-700 text-xl md:text-2xl mb-4">Company & Support</h2>
                <ul className="space-y-2">
              ...
              {/* Legal & Privacy */}
              <div>
                <h2 className="font-bold text-teal-700 text-xl md:text-2xl mb-4">Legal & Privacy</h2>
                <ul className="space-y-2">
              ...
              {/* Other Features */}
              <div>
                <h2 className="font-bold text-teal-700 text-xl md:text-2xl mb-4">Other Features</h2>
                <ul className="space-y-2">
